...
public class ReadWriteUserScreen {
    ...
    private void  CreateNewUser() throws Exception
    {
        try {
            ...
            switch (userType) {
                case 1: {
                    Main.userService.addNewUser(UserType.ReadWriteUser,
                ...
                case 2: {
                    ...
                    Main.userService.addNewUser(UserType.ReadOnlyUser,
    ...
    private void UpdateExistUser() throws Exception
    {
        try {
            ...
            String  username = reader.readLine();
            User selectedUser = Main.userService.getUserByGivenCriteria(UserOpsBean.UserCriteria.UserName, new User().setUserName(username)).get(0);
               ...
               for (Product genProduct: products)
                {
                    if(product.getName().equals(genProduct.getName()))
                    {
                        ...
                        Main.productService.updateProductByName(ProductCriteria.quantity, genProduct.getName(),genProduct);
                    }
                }
            }
        }
